...
use App\AdjacencyList\AdjacencyListBuilder;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\Relation;
use Illuminate\Support\Collection;

class SiblingsRelation extends Relation
{
    ...
    {
        $queryBuilder = (new AdjacencyListBuilder($parent->getTable(), $parent->id))->getQuery();
        $builder = new Builder($queryBuilder);
        $builder->setModel($parent);
